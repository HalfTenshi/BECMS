...
// NOTE: Auth/JWT belum—di langkah #2 nanti.
// Di sini fokus CRUD user dan validasi dasar.

class UserService {
  list(query) {
    // normalisasi page/limit ke number
  ...
  async create(body) {
    ...
    // passwordHash opsional (nanti akan diganti proses hash di Auth step #2)
    return userRepository.create({ name, email, pictureUrl, passwordHash, status });
  }
